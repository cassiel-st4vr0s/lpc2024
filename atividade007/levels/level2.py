...
import sys
from settings import combinations_size, letters_2
...
class Level_2:
    ...
    def sequence_generator(self): #função que controla a criação das sequencias das letras
        ...
        for size in range(1, combinations_size + 1): #limita o numero maximo de elementos
            for word in product(letters_2, repeat = size):
    ...
    def draw(self):
        ...
        for i, platform in enumerate(self.platforms) :
            ...
            text_rect = text_surface.get_rect(
                center=(platform.x + PLATFORM_WIDTH / 2, platform.y + PLATFORM_HEIGHT / 2 + 8))
